...
There is also a [swerve constants reference page](/docs/pathing/tuning/swerve/swerve-constants-example) that you can use to see a fully setup swerve config. Finally, if you have any other questions, please feel free to reach out to me (@_kubar) on discord through the Pedro discord server
(preferred) or DMs.
