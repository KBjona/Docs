...
<Callout title="Important" type="warning">
    Make sure that the **Localizer** and **Drivetrain** that you send into the new Follower match your own.
</Callout>
...
Now that we have finished tuning the robot, we can [test](/docs/pathing/tuning/test) everything combined.