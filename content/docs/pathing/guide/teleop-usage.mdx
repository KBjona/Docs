...
You can use Pose objects in your methods (and subsystems if you use them), and send your robots Pose to them, so you code can use your location (eg. Turrets, making sure you are in a zone)
...
```
This code will set our robots position to a corner when we press "Start".
